...
void print1() {
    ...
    gemm_reg_v3<128, 16, 128, 8, 8>(hA, hB, hC_gpu, M, K, N);
    // gemm_reg_v4(hA, hB, hC_gpu, M, K, N);
    // gemm_reg_v5(hA, hB, hC_gpu, M, K, N);
    gemm_reg_v5_p<128, 8, 128, 8, 8>(hA, hB, hC_gpu, M, K, N);
    // gemm_reg_v5_swizzle(hA, hB, hC_gpu, M, K, N);
    // gemm_reg_v6_1<256, 16, 256, 16, 16>(hA, hB, hC_gpu, M, K, N);
    // gemm_reg_v6_2<256, 16, 256, 16, 16>(hA, hB, hC_gpu, M, K, N);

    gemm_reg_v5_TM16<256, 16, 256, 16, 16>(hA, hB, hC_gpu, M, K, N);
